        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                        ...
                        <Link href="/adopt">
                            <Button variant="ghost" className="gap-2 text-rose-600 hover:text-rose-700 hover:bg-rose-50/70 text-base font-semibold rounded-full px-6">
            ...
            <section className="py-28 relative overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <div className="absolute top-0 left-1/4 w-96 h-96 bg-rose-300/15 rounded-full blur-3xl animate-float" />
                    <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-amber-300/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
                </div>

                <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-rose-100/80 mb-8">
                        <Sparkles className="w-8 h-8 text-rose-500" />
                    </div>

                    <h2 className="text-4xl md:text-5xl font-bold mb-6 text-stone-800 leading-tight">
                        Our Mission
                    </h2>
                    <p className="text-xl text-stone-500 mb-16 leading-relaxed max-w-2xl mx-auto">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="glass-card rounded-[32px] p-12 md:p-16 text-center max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link href="/volunteer">
                                <Button size="lg" variant="outline" className="h-14 px-8 rounded-2xl border-2 border-stone-200 hover:border-rose-300 text-stone-700 hover:text-rose-600 font-semibold transition-all duration-300">
                                    Become a Volunteer
                                </Button>
                            </Link>
                        </div>
