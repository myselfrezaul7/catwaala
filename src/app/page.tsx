                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
                        <div className="space-y-2">
                            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 font-heading">
                                Meet Our <span className="text-rose-600">Stars</span>
                            </h2>
                            <p className="text-slate-500 dark:text-slate-400 max-w-md">
                                These adorable cats are looking for their forever homes
                            </p>
                        </div>
                        <Link href="/adopt">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <div className="bg-white dark:bg-zinc-800 px-8 py-4 rounded-2xl shadow-sm">
                            ...
                            <span className="text-sm font-bold text-slate-500 uppercase tracking-wider">Cats TNR&apos;d</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 px-8 py-4 rounded-2xl shadow-sm">
                            <span className="block text-3xl font-bold text-indigo-600 mb-1">200+</span>
