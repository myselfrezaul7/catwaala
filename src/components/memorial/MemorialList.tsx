                    ...
                    <AnimatePresence mode="popLayout">
                        {memorials.map((memorial, index) => (
                            <motion.div
                                ...
                                className="group glass-card rounded-[2rem] overflow-hidden hover:shadow-2xl hover:shadow-rose-100/50 transition-all duration-500 hover:-translate-y-2 relative"
                            >
