...
import { Facebook, Instagram, Mail, Cat, Heart, PawPrint, ArrowRight } from "lucide-react";
            ...
            <div className="relative z-10 pt-8 md:pt-16 pb-4 md:pb-8">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex justify-center sm:justify-start mb-8 md:mb-12">
                        <Link href="/donate" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-teal-600 hover:bg-teal-700 text-white text-sm font-bold shadow-sm transition-all hover:-translate-y-0.5">
                            <span>🐾</span> Support the Paws <ArrowRight className="w-4 h-4 ml-1" />
                        </Link>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 mb-8 md:mb-12 text-center sm:text-left">
                        {/* Brand */}
                        ...
                        {/* Quick Links & Resources Desktop + Mobile 2-cols */}
                        <div className="col-span-1 md:col-span-2 grid grid-cols-2 gap-6">
                            {/* Quick Links */}
                            <div>
                                <h4 className="font-bold mb-4 text-foreground text-sm uppercase tracking-wider">Quick Links</h4>
                            ...
                            {/* Resources */}
                            <div>
                                <h4 className="font-bold mb-4 text-foreground text-sm uppercase tracking-wider">Resources</h4>
                                <ul className="space-y-2">
                                    {[
                                        { href: "/faq", label: "FAQ" },
                                        { href: "/quiz", label: "Cat Quiz" },
                        ...
                        <div className="col-span-1 md:col-span-1 flex flex-col items-center sm:items-start">
                            <h4 className="hidden md:block font-bold mb-4 text-foreground text-sm uppercase tracking-wider">Connect</h4>
                            <div className="flex flex-wrap justify-center sm:justify-start gap-2.5 mb-4">
                                <a href="https://www.facebook.com/groups/catwaala/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background border border-border rounded-xl text-muted-foreground hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-300 shadow-sm" aria-label="Facebook"><Facebook className="w-5 h-5" /></a>
                                <a href="https://www.instagram.com/catwaala/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background border border-border rounded-xl text-muted-foreground hover:text-white hover:bg-[#E1306C] hover:border-[#E1306C] transition-all duration-300 shadow-sm" aria-label="Instagram"><Instagram className="w-5 h-5" /></a>
                                <a href="https://www.youtube.com/@catwaala" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background border border-border rounded-xl text-muted-foreground hover:text-white hover:bg-[#FF0000] hover:border-[#FF0000] transition-all duration-300 shadow-sm" aria-label="YouTube"><YoutubeIcon className="w-5 h-5" /></a>
                                <a href="https://www.tiktok.com/@catwaala" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background border border-border rounded-xl text-muted-foreground hover:text-white hover:bg-black dark:hover:bg-zinc-800 hover:border-black dark:hover:border-zinc-800 transition-all duration-300 shadow-sm" aria-label="TikTok"><TikTokIcon className="w-5 h-5" /></a>
                            </div>
                            <a href="mailto:catwaala@gmail.com" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-primary transition-colors">
                    ...
                    {/* Copyright */}
                    <div className="pt-6 border-t border-border/50 flex justify-center text-center text-sm text-muted-foreground">
