...
const verifiedVets = [
    ...
    },
    {
        ...
        services: ["Specialist Care", "Surgery", "Emergency", "Research"],
    ...
    },
    {
        ...
        services: ["Rescue", "Spaying/Neutering", "Vaccination"],
    ...
    },
    {
        ...
        website: "",
        services: ["General Checkup", "Vaccination", "Treatment"],
        hours: "10:00 AM - 8:00 PM",
        rating: 4.5,
        reviewCount: 45,
    ...
    },
    {
        ...
        website: "",
        services: ["General Checkup", "Vaccination", "Grooming", "Surgery"],
        hours: "10:00 AM - 9:00 PM",
        rating: 4.8,
        reviewCount: 67,
    ...
    },
    {
        ...
        website: "",
        services: ["Surgeries", "Diagnostics", "Grooming"],
        hours: "10:00 AM - 8:00 PM",
        rating: 4.6,
        reviewCount: 52,
    ...
    // Verified Government Specifics from Portal.gov.bd
    {
...
export const REAL_BD_VETS: Omit<VetClinic, "id">[] = ${JSON.stringify(verifiedVets, null, 4).replace(/"([^"]+)":/g, '$1:')};
`;

fs.writeFileSync('src/data/bd-vets.ts', fileContent);
fs.writeFileSync('../kuttawaala/src/data/bd-vets.ts', fileContent);

console.log('Successfully updated bd-vets.ts with ' + verifiedVets.length + ' VERIFIED entries in both projects.');
